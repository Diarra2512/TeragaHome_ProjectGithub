...
<div class="container py-5" style="max-width: 900px;">
    ...
    <div class="card shadow-sm rounded-4 p-4 border border-primary">
        <form method="POST" action="{{ route('properties.update', $property) }}" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label text-primary fw-semibold">Titre *</label>
                    <input type="text" name="title" class="form-control border-primary"
                           value="{{ old('title',$property->title) }}" required>
                </div>

                <div class="col-md-6">
                    <label class="form-label text-primary fw-semibold">Type *</label>
                ...
                <div class="col-md-3">
                    <label class="form-label text-primary fw-semibold">Contrat *</label>
            ...
            <div class="mt-4">
                <label class="form-label fw-semibold text-primary">Commodités</label>
                <div class="row">
            ...
            {{-- ---------- 4. Images existantes ---------- --}}
            <div class="mt-4">
                <label class="form-label fw-semibold text-primary">Images actuelles</label>
                    ...
                    @foreach($property->images as $img)
                        <div class="text-center">
                            ...
                            <div class="form-check mt-1">
                                ...
                                <label class="form-check-label text-primary small" for="del-{{ $img->id }}">
                                    Supprimer
                                </label>
                            </div>
                        </div>
            ...
            <div class="mt-4">
                <label class="form-label fw-semibold text-primary">Ajouter des images</label>
...
input.form-control:focus,select.form-select:focus,textarea.form-control:focus{
    border-color:#0d6efd;box-shadow:0 0 0 .25rem rgba(13,110,253,.25)}
...
.img-thumbnail.border-primary{border:2px solid #0d6efd}
</style>
@endpush
